...
<body>
	<?php echo "<a href=\"index.php?id=$idUsuario\">Página principal</a>";?> | <a href="logout.php">Cerrar sesión</a>
	<br/><br/>
	...
	<table width='80%' border="1">
		...
		while($res = mysqli_fetch_array($result)) {	
            ...
            $precioTotal = 0;
            echo "<td><a href=\"reservar.php?paq=$res[idPaquete]&id=$_SESSION[idUsuario]\" onClick=\"return confirm('¿Está seguro que desea reservar el paquete?')\">Reservar</a></td>";
			echo "</tr>";		
		}
		?>
	</table>	
